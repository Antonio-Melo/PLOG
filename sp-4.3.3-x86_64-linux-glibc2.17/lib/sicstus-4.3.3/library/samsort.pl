...
%@  is given a proper list @var{RawList} and unifies @var{Sorted} with a list
...
%@  is given a proper list @var{RawList} and a binary predicate @var{Order}
%@  (note that it may be an @var{N-ary} predicate with the first @var{N-2}
%@  arguments already filled in) and unifies @var{SortedList} with a
%@  sorted version of @var{RawList}. 
...
%@  is given a proper list @var{RawList} of @var{Key-Value} pairs, and unifies
