...
#define SICSTUS_MINOR_VERSION 3
#define SICSTUS_REVISION_VERSION 3
...
/* [PD] 3.11.1 */
#define SICSTUS_VERSION_STRING "4.3.3"
...
#define SP_GET_DISPATCH_NAME SP_get_dispatch_40303
...
#define SP_JIT_PRELOAD_FAIL_STRING "no"
#define SP_JIT_USE_LQ_STQ_STRING "no"
...
#define SP_RTSYS_DIRNAME "sp-4.3.3"
#define SP_EMULATOR_DIRNAME "sicstus-4.3.3"
/* [PM] 3.11.0 */
#define LICENSE_PRODUCT "sicstus4.3_linux"
...
/* [PM] 4.0.5 note that all code and headers assume this is 1. Present
   for backwards compatibility  */
#define SP_DISPATCH_API 1

/* [PM] 4.0.5 Put stash and API dispatch together in struct
   open_resource. Assumed true in all code. Present for backwards
   compatibility. */
...
/* [PM] 4.0.5 Special things needed for supporting multiple sicstuses
   in the same process. Assumed true in all code. Present for
...
/* whether valgrind-specific features should be enabled (like
   alternate code that triggers less warnings). Should be usuall be
...
#define RTKERNEL_BASENAME_SANS_SUFFIX_STRING "libsprt4-3-3"
#define RTKERNEL_BASENAME_WITH_DSO_SUFFIX_STRING "libsprt4-3-3.so"
...
/* Something like "libsprt-4-1-2-instance-XX.so". Must contain exactly
   ...
   literal string) */
#define RTKERNEL_INSTANCE_TEMPLATE_STRING "libsprt4-3-3-instance-XX"
...
/* [PM] 4.3 true if '$VAR'(X) should write X also when not integer(X), X>=0. */
#define ENABLE_WRITE_DOLLAR_VAR_LEGACY 0
...
/* [PM] 4.1.3 Use SP__FUNCTION__ or SPIO__FUNCTION__ instead: #define HAVE___FUNCTION__ 0 */
...
#define SP_X86_64 SP_X64 /* an alias */
